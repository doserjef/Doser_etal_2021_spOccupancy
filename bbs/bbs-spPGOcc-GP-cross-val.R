# bbs-spPGOcc-GP-cross-val.R: this script runs a single species spatial occupancy 
#                             model with 10-fold cross-validation for Black-throated
#                             Blue Warbler across the eastern US in 2018. The 
#                             model is fit with a full Gaussian Process.
